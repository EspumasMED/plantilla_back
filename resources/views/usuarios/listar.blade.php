                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-end mb-2">
                                <a href="{{ url('/usuarios/listaelimina') }}" class="btn btn-danger">Eliminados</a>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                                    ...
                                                    @if (auth()->user()->id == $item->id)
                                                        ...
                                                        <td class="text-muted">
                                                            ...
                                                            @if ($item->tipo == 'Administrador')
                                                                <span
                                                                    class="badge bg-success text-white">Administrador</span>
                                                            @else
                                                                <span class="badge text-bg-warning bg-warning">Cajero</span>
                                                            @endif
                                                        </td class="text-muted">
                                                        <td class="text-muted">
                                                            <p>Usuario Actual</p>
                                            ...
                                            @else
                                                ...
                                                <td>
                                                    @if ($item->tipo == 'Administrador')
                                                        <span class="badge bg-success text-white">Administrador</span>
                                                    @else
                                                        <span class="badge text-bg-warning bg-warning">Cajero</span>
                                                    @endif
                                                </td>
